...
//ini_set('display_errors', 1); ini_set('display_startup_errors', 1);error_reporting(E_ALL);exit('FOK');
            ...
            <div class="span12">
                <div id="risk-table-container">
                    <form action="/" method="post">
                                    <!-- <form method="post" name="get_risks_by"> -->
                                     ...
                                     <!-- S<button  name="get_risks_by" onclick="exportData()" id="generatepdf" value="GENERATE PDF"> -->
                    </form>
                    <input type="button" name = "excelbutton" id = "excelbutton" value="Download Excel" onclick="DownloadexcelFile()" />                   <input type="button" name = "pdfbutton" id = "pdfbutton" value="Download PDF" onclick="DownloadpdfFile()" />
<script type="text/javascript">      
         function DownloadexcelFile(){ 
         $("#risks").table2excel({                                                                                                                                                                                           
               // exclude CSS class           
                    name:"Worksheet Name",
                    filename:"Risk Report",//do not include extensio
