...
if (isset($_GET['id']))
{
    ...
    //linf _formula
        //$GLOBALS['mitigationimpact'] = $mitigation[0]['mitigationimpact']? isset('mitigationimpact');
        //$GLOBALS['mitigationlikelihood'] = $mitigation[0]['mitigationlikelihood'] ? isset('mitigationlikelihood');

       // $score = ($GLOBALS['mitigationimpact'] * $GLOBALS['mitigationlikelihood'] ) * 4;
       //
      // echo $score;
       //linf
       // $mitigation_percent = $score;
    }
    // Otherwise
    else
    {
