            ...
            <div class="modal-body">
                <div class="form-group">
                   ...
                   echo '</select>'; ?>
                    ...
                    <!--  <label for=""><?php echo $escaper->escapeHtml($lang['CurrentLikelihood']); ?></label>-->
                   
                  <!-- ? GLOBAL $CLASSIC_likelihood = get_name_by_value("likelihood", $risk[0]['CLASSIC_likelihood']);?-->
                  
                  <!--<div><?php echo create_dropdown('likelihood',NULL, 'likelihood', true, false, true) ?></div>-->
