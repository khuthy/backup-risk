...
$(document).ready(function() {
   ...
   /****** $('body').on('click', '[name=update_control_risk]', function(e) {
        e.preventDefault();
         alert('update_control');
         //updateControlRisk($(this));
    });
     end mitigation *******/
 
function updateControlRisk($this){ 

    $('#update-control-forms').submit(function(){

var form = new FormData($(this)[0]);
$.ajax({
    type: 'POST',
    url: BASE_URL + '/api/management/update_control',
    data: form,
    async: true,
    cache: false,
    contentType: false,
