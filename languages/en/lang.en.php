...
$lang = array(
    ...
    'Logout'=>'Logout',
    'LogInHere'=>'Login to Geoscience Management System',
    'Username'=>'Username',
    'Password'=>'Password',
    ...
    'CurrentLikelihood'=>'Inherent Likelihood',
    'CurrentImpact'=>'Inherent Impact',
    ...
    //'CurrentSolution'=>'Implemented Solution',
    'CurrentSolution'=>'Planned Mitigation',
    'RiskEffectiveness'=>'Risk Effectiveness',
    'SecurityRequirements'=>'Security Requirements',
    'SecurityRecommendations'=>'Additional Comments',
    ...
    'Register'=>'Register',
    'RegisterSimpleRisk'=>'Register Geoscience Management System',
    'RegistrationText'=>'Registered Geoscience Management System instances are immediately granted access to the Upgrade and ComplianceForge SCF Extras.  The Upgrade Extra provides the ability to back up and upgrade your Geoscience Management System instance with the click of a button.  The ComplianceForge SCF Extra provides a common control framework that is integrated into the Geoscience Management System Governance functionality.  Upon registering Geoscience Management System, your registration information will be sent to a server hosted by Geoscience Management System.  The registration information provided will be used by Geoscience Management System to notify customers of new releases and security updates.  The act of registering Geoscience Management System will opt you into our marketing communications, but you may opt out at any time using the unsubscribe link in these communications.  Geoscience Management System respects the privacy of our customers and information provided to us through the Geoscience Management System registration process will never be sold to a third-party.',
    'RegistrationInformation'=>'Registration Information',
    'Company'=>'Company',
    'JobTitle'=>'Job Title',
    'Phone'=>'Phone',
    'UpgradeSimpleRisk'=>'Upgrade Geoscience Management System',
    ...
    'CustomExtrasText'=>'It would be awesome if everything were free, right?  Hopefully the core Geoscience Management System platform is able to serve all of your risk management needs.  But, if you find yourself still wanting more functionality, we\'ve developed a series of "Extras" that will do just that.',
    'Upgrade'=>'Upgrade',
    'Install'=>'Install',
    'Purchase'=>'Purchase',
    ...
    'SimpleRiskColumnMapping' => 'Geoscience Management System Column Mapping',
    'Mapping' => 'Mapping',
    'Optional' => 'Optional',
    ...
    'UnauthenticatedAccessInAPI' => 'Unauthenticated Access.  Please log in or provide a key to use the Geoscience Management System API.',
    ...
    'MitigationPercent' => 'Control Effectiveness',
    ...
    'MitigationImpact' => 'Residual Impact',
    'MitigationLikelihood' => 'Residual Likelihood',
    ...
    'ImportCsvXlsFile' => 'Import the following CSV or XLS file into Geoscience Management System',
    ...
    'SimpleRiskActionNotifications' => 'Geoscience Management System Action Notifications',
    ...
    'SimpleRiskURL' => 'Geoscience Management System URL',
    'Period' => 'Period',
    'PlaceTheFollowingInYourCrontabToRunAutomatically' => 'Place the following in your crontab to run automatically',
    'SimpleRiskScheduledNotifications' => 'Geoscience Management System Scheduled Notifications',
    ...
    'SelectForControlsEffectiveness' => 'Select for Controls Effectiveness',
    ...
    'MitigationSuccess' => 'Mitigation for Risk with ID "{$subject}" has been submitted successfully.',
    'Accepting' => 'Accepting...',
    'Rejecting' => 'Rejecting...',
    ...
    'YouNeedToUpgradeYourSimpleRiskSubscription' => 'You need to upgrade your Geoscience Management System subscription to enable use of this Extra.',
    ...
    'RiskFormRemark' => 'Complete the form above to register Risk ',
    ...
    'SimpleriskContributingRiskCalculator' => 'Geoscience Management System Contributing Risk Calculator',
    ...
    'EncryptionBackupFileExists' => 'As part of the encryption process, an unencrypted backup copy of your Geoscience Management System database has been created.  Once you have verified everything has encrypted properly, move it to a secure location or click the button to delete it.',
    ...
    'Asset' => 'Asset',
    'FailedToRegisterInstance' => 'Failed to register your Geoscience Management System instance. Please contact info@geoscience.gov.za for assistance.',
    'FailedToUpdateInstance' => 'Failed to update your Geoscience Management System registration. Please contact info@geoscience.gov.za  for assistance.',
    'FailedToDownloadExtra' => 'Failed to download the requested extra. Please contact info@geoscience.gov.za  for assistance.',
    'RequestedExtraIsNotPurchased' => 'The requested extra is not purchased yet. Please contact info@geoscience.gov.za  for assistance.',
    'RequestedExtraDoesNotExist' => 'The requested extra does not exist. Please contact info@geoscience.gov.za  for assistance.',
    'InstanceWasRegisteredWithDifferentIp' => 'Your Geoscience Management System instance was registered with a different IP address. Please contact info@geoscience.gov.za  for assistance.',
    'InstanceIsDisabled' => 'Your Geoscience Management System instance is disabled. Please contact info@geoscience.gov.za  for assistance.',
    'InvalidInstanceIdOrKey' => 'Your Geoscience Management System instance or key is invalid. Please contact info@geoscience.gov.za  for assistance.',
    ...
    'NextReviewDateFixDisclaimer' => 'We have detected a possible issue with the date formats stored in your Geoscience Management System database.  The table below will show you which risks have an invalid date format and need to be corrected. Please take a look at the suspected date format, confirm that it is correct, and then click "Confirm" to have it updated in the database.',
    ...
    'SimpleriskBaseUrl' => 'Geoscience Management System Base URL',
    ...
    'CacheClearWarning' => 'Often times new Geoscience Management System releases will provide updates to stylesheets, images, and javascript that may have been cached by your web browser.  Please clear your browser cache to ensure that Geoscience Management System looks like it should after the upgrade.',
    ...
    'JiraWebhookNoBodyPosted' => 'The jira webhook did not post a body! Please contact info@geoscience.gov.za ',
    ...
    'JiraWebhookNotSupportedOnHttp' => 'You have to run your Geoscience Management System instance on https to be able to use this extra.',
    ...
    'JiraCreateIssueOnNewRisk' => 'Allow Geoscience Management System to create new Jira issues when a Risk is created.',
    ...
    'JiraIssueTypeForNewIssueInstructions' => 'Please select "Task"! This step is required as we can\'t identify the "Task" issue type with a 100% certainty based on the data the Jira instance is providing. If for your use-case you\'d need support for other issue types as well, please contact info@geoscience.gov.za .',
    
    'JiraCreateRiskOnNewIssue' => 'Allow Geoscience Management System to create new Risk when a new Jira issue is detected.',
    'JiraScanProjectsForNewIssues' => 'Scan Projects',
    'JiraScanProjectsForNewIssuesInstructions' => 'Enter a comma separated list of Project Keys. Geoscience Management System will check these projects for new issues.',
    ...
    'JiraAllowWebhookManagement' => 'Allow the Geoscience Management System instance to manage Webhooks on the Jira instance',
