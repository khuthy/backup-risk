<?php
    ...
    if (is_authenticated())
    {
        ...
        getRoute()->post('/management/risk/updateControl', 'updateControl');
        getRoute()->post('/management/updateControl', 'updateControl');
        ...
        getRoute()->post('/risk_management/updateControl', 'updateControl');
