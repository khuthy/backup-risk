...
function is_valid_user($user, $pass, $upgrade = false)
{
    ...
    {
        // Write the debug log
        write_debug_log("Not a valid user in geoscience.");
...
function login($user, $pass){
    ...
    //linde all above is useless considering simple application , nelow is for hen no extras
    else
    {

        // If the encryption extra is enabled//linde we do not need this
        if (encryption_extra())
        {
            // Load the extra
            require_once(realpath(__DIR__ . '/../extras/encryption/index.php'));
