...
function add_risk_details(){
    ...
    echo "<form name=\"submit_risk\" method=\"post\" action=\"\" enctype=\"multipart/form-data\" id=\"risk-submit-form\">\n";
        echo "<div class=\"row-fluid padded-bottom subject-field\">\n";
          ...
          //linf echo "<div class=\"span2 text-right\">Risk Name:</div>\n";
    ...
    //     {
            echo "<div class=\"row-fluid\">\n";
                ...
                echo "<div class=\"span5 left-panel\">\n";
                  ...
                  //lindenow  display_affected_assets_edit('');
    ...
    else
    {
        echo "<div class=\"row-fluid\">\n";
            ...
            //    display_external_reference_id_edit($reference_id);
              ...
              //lindenow  display_affected_assets_edit($id);
...
*************************************/
function view_mitigation_details($risk_id, $mitigation_date, $planning_strategy, $mitigation_effort, $mitigation_cost, $mitigation_owner, $mitigation_team, $current_solution, $security_requirements, $security_recommendations, $planning_date, $mitigation_percent, $mitigation_controls, $controls_effectiveness)
{
    global $lang;
    global $escaper;
    ...
    else
    {
        echo "<div class=\"row-fluid\">\n";
            ...
            echo "<div class=\"span5 left-panel\">\n";
               ...
               // display_mitigation_effort_view($mitigation_effort);
                ...
                display_control_effectiveness_view($controls_effectiveness);

                //display_mitigation_percent_view($mitigation_controls);
            ...
            echo "<div class=\"span5 right-panel\">\n";
                ...
                //display_risk_effectiveness_view($security_requirements);
        ...
        echo "<div class=\"row-fluid \">\n";
            echo "<div class=\"span12 bottom-panel\">\n";
            print_mitigation_controls_table($mitigation_controls,$controls_effectiveness,$risk_id);
            echo "</div>";
        echo "</div>";
    }
...
function view_print_mitigation_details($id, $mitigation_date, $planning_strategy, $mitigation_effort, $current_solution, $security_requirements, $security_recommendations)
{
   ...
   // echo "</tr>\n";
	...
	//linfinal  remove
     echo "<tr>\n";
     echo "<td width=\"200\"><b>" . $escaper->escapeHtml($lang['RiskEffectiveness']) . ":</td>\n";
...
*************************************/
function edit_mitigation_details($risk_id, $mitigation_date, $planning_strategy, $mitigation_effort, $mitigation_cost, $mitigation_owner, $mitigation_team,  $current_solution, $security_requirements, $security_recommendations, $planning_date, $mitigation_percent, $mitigation_controls, $controls_effectiveness)
{
    global $lang;
    global $escaper;
    ...
    else
    {
        echo "<div class=\"row-fluid\">";
            echo "<div class=\"span5 left-panel\">";
               ...
               // display_mitigation_percent_edit($mitigation_percent);
                display_control_effectiveness_edit($controls_effectiveness);
                display_mitigation_controls_edit($mitigation_controls);
            echo "</div>";
            //linlast added the two to get the perfecetage to be attached to mitigation percentage
        ...
        <div class=\"row-fluid\">
            <div class=\"span5 text-right\">"
                .$escaper->escapeHtml($lang['MitigationImpact']) .":
            </div>
            
    ";
            echo "<div class=\"span7\">";
                     $mitigationimpacts = array('Insignificant', 'Minor','Moderate','Major','Critical');
                 
                     
                    //  $mitigationimpacts = array('1', '2','3','4','5');

                    //  echo '<select name="mitigationimpact">
                    //     <option value="0">Mitigation Impact</option>';
                    //     $options = 0;
                    //     foreach ($mitigationimpacts as $selection) {
                    //         $GLOBALS['selectedimpact'] = ($options == $selection) ? "selected" : "";
                    //         echo '<option '.$GLOBALS['selectedimpact'].' value="'.$mitigationimpacts[$selection].'">'.$mitigationimpacts[$selection].'</option>';
                    //     }
                    ...
                    //$mitigationimpacts = array('1', '2','3','4','5');
                     ...
                     echo '<select name="mitigationimpact">
                        ...
                        $options = isset($mitigation[0]['residual_impact']) ? $mitigation[0]['residual_impact'] : 0;
                        foreach ($mitigationimpacts as $selection) {
                            $GLOBALS['selectedimpact'] = ($options == $selection) ? "selected" : "";
                            echo '<option '.$GLOBALS['selectedimpact'].' value="'.$selection.'">'.$selection.'</option>';
                        }

                    echo '</select>';
                    echo "</div></div>";

                     // $mitigationlikelihood = array('1', '2','3','4','5');
                    $mitigationlikelihood = array('Rare', 'Unlikely','Moderate','Likely','Almost Certain');
                    echo "
        <div class=\"row-fluid\">
            <div class=\"span5 text-right\">"
                        .$escaper->escapeHtml($lang['MitigationLikelihood']) .":
            </div>
                            
    ";
                    // echo '<select name="mitigationlikelihood">
                    //     <option value="0">Mitigation Likelihood</option>';

                    //     $options = 0;

                    //     foreach ($mitigationlikelihood as $selection) {
                    //          $GLOBALS['selectedlikelihood'] = ($options == $selection) ? "selected" : "";
                    //         echo '<option '.$GLOBALS['selectedlikelihood'].' value="'.$mitigationlikelihood[$selection].'">'.$mitigationlikelihood[$selection].'</option>';
                    //     }
                    ...
                    echo '<select name="mitigationlikelihood">
                       ...
                       // $options = 0;
                       $optionslikely = isset($mitigation[0]['residual_iikelihood']) ? $mitigation[0]['residual_iikelihood'] : 0;
                        foreach ($mitigationlikelihood as $selection) {
                             $GLOBALS['selectedlikelihood'] = ($optionslikely == $selection) ? "selected" : "";
                            echo '<option '.$GLOBALS['selectedlikelihood'].' value="'.$selection.'">'.$selection.'</option>';
                        }
                ...
                //display_risk_effectiveness_edit($security_requirements);
...
***********************************************/
function print_mitigation_controls_table($control_ids,$control_effectiveness,$risk_id){
    global $lang;
    global $escaper;
    $key = uniqid(rand());
    ...
    <form class="" id="update-control-forms" action="#control--update" method="post" autocomplete="off">
    <br/>
    <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal">&times;</button>
    <h4 class="modal-title"><?php echo 'Edit Control'; ?></h4>
    </div>

            <div class="modal-body">
                <input type="hidden" class="control_id" name="control_id" id="control_id" value=""> 
                <div class="form-group">
                    ...
                    <!--  <input type="number" min="0" max="100" name="mitigation_percent" value="" class="form-control">-->
                     <?php $mitigationimpacts = array('100'=>'Very Good - 100%','80'=>'Good - 80%','50'=>'Satisfactory - 50%','30'=>'Weak - 30%','10'=>'UnSatisfactory - 10%');
            
                        echo '<select name="mitigation_percent" id="mitigation_percent">';
                        $options = isset($control_effectiveness) ? $control_effectiveness : "";
                        foreach ($mitigationimpacts as $selections => $selection) { 
                            $GLOBALS['control_effectiveness'] = ($options == $selection) ? "selected" : "";
                            echo '<option '.$GLOBALS['control_effectiveness'].' value="'.$selections.'">'.$selection.'</option>';
                        }
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="update_control_risk" class="btn btn-danger"><?php echo $escaper->escapeHtml($lang['Update']); ?></button>
            </div>

        </form>
    </div> 
    <?php
    //<input type=\"hidden\" value=\"" . $control_effectiveness . "\" class='active-textfield control_effectiveness' /> 
       echo " <br>
...
$(document).ready(function(){ 
 ...
 $(document).on('click', '[name=update_control_risk]', function(e) {
        e.preventDefault();     
    var form  = new FormData();
var modal = $('#control--update');

form.append('control_id', $('[name=control_id]').val());
form.append('short_name', $('[name=short_name]', modal).val());
form.append('long_name', $('[name=long_name]', modal).val());
form.append('description', $('[name=description]', modal).val());
form.append('supplemental_guidance', $('[name=supplemental_guidance]', modal).val());
form.append('enabled_users', $('#enabled_users').val());
form.append('frameworks', $('#frameworks').val());
form.append('control_class', $('[name=control_class]', modal).val());
form.append('control_phase', $('[name=control_phase]', modal).val());
form.append('control_number', $('[name=control_number]', modal).val());
form.append('control_priority', $('[name=control_priority]', modal).val());
form.append('family', $('[name=family]', modal).val());
form.append('mitigation_percent', $('[name=mitigation_percent]', modal).val()); 
...
.fail(function(xhr, textStatus){
        ...
        $(document).on('click', '.control-block--edit', function(event) {
            ...
            $.ajax({
                ...
                success : function (res){
                    ...
                    $('[name=control_id]', modal).val(control_id);
 ...
 var value = '';
var e = document.getElementById('control_effectiveness');
if(e){

 value = e.value;
}else{value = '{$control_effectiveness}';
}
...
function view_top_menu($active)
{
    ...
    if ($active == "Home")
    {
        ...
        echo "<a class=\"brand\" href=\"https://www.geoscience.org.za/\"><img src='images/logo@2x.png' alt='geoscience' /></a>\n";
...
//
       ...
       // }
        ...
        if (isset($_SESSION["access"]) && $_SESSION["access"] == "granted")
        {
         ...
         echo "<div class=\"btn-group pull-right\">\n";
          //linde echo "<a class=\"btn dropdown-toggle\" data-toggle=\"dropdown\" href=\"#\">" . $escaper->escapeHtml($_SESSION['name']) . "<span class=\"caret\"></span></a>\n";
            echo "<ul class=\"dropdown-menu\">\n";
            echo "<li>\n";
    ...
    else
    {
        ...
        echo "<div class=\"navbar-inner\">\n";
        echo "<div class=\"container-fluid\">\n";
        echo "<a class=\"brand\" href=\"http://172.16.6.115:81/riskapp\"><img src='../images/logo@2x.png' alt='SimpleRisk Logo' /></a>\n";
        echo "<div class=\"navbar-content\">\n";
        echo "<ul class=\"nav\">\n";
     ...
     //       echo "<a href=\"../compliance/index.php\">" . $escaper->escapeHtml($lang['Compliance']) . "</a>\n";
      //      echo "</li>\n";
       //lindenow }
        ...
        // If the user has asset management 
        //lindenow
      //  if (isset($_SESSION["asset"]) && $_SESSION["asset"] == "1")
      //  {
     //       echo ($active == "AssetManagement" ? "<li class=\"active\">\n" : "<li>\n");
     //       echo "<a href=\"../assets/adddeleteassets.php\">" . $escaper->escapeHtml($lang['AssetManagement']) . "</a>\n";
      //      echo "</li>\n";
      //  }
...
function view_asset_management_menu($active)
{
    ...
    echo "<ul class=\"nav nav-pills nav-stacked aside--nav \">\n";
   //linde echo ($active == "AutomatedDiscovery" ? "<li class=\"active\">\n" : "<li>\n");
    //linde echo "<a href=\"index.php\"> <span>1</span>" . $escaper->escapeHtml($lang['AutomatedDiscovery']) . "</a>\n";
    //linde echo "</li>\n";
   ...
   // if (assessments_extra())
    //{
     ...
     //   require_once(realpath(__DIR__ . '/../extras/assessments/index.php'));
        ...
        //linde view_assessments_extra_menu($active);
  //  }
...
function view_configure_menu($active)
{
  ...
  //  }
    ...
    //linde echo ($active == "Extras" ? "<li class=\"active\">\n" : "<li>\n");
    //linde echo "<a href=\"extras.php\">" . $escaper->escapeHtml($lang['Extras']) . "</a>\n";
    //linde echo "</li>\n";

    //linde echo ($active == "Announcements" ? "<li class=\"active\">\n" : "<li>\n");
    //linde echo "<a href=\"announcements.php\">" . $escaper->escapeHtml($lang['Announcements']) . "</a>\n";
    //linde echo "</li>\n";

   //linde echo ($active == "Register" ? "<li class=\"active\">\n" : "<li>\n");
    //linde echo "<a href=\"register.php\">" . $escaper->escapeHtml($lang['RegisterAndUpgrade']) . "</a>\n";
    //linde echo "</li>\n";
...
function view_get_risks_by_selections($status=0, $group=0, $sort=0, $affected_assets_filter=0, $tags_filter=0, $locations_filter="", $id=true, $risk_status=false, $subject=true, $reference_id=false, $regulation=false, $control_number=false, $location=false, $source=false, $category=false, $team=false, $additional_stakeholders=false, $technology=false, $owner=false, $manager=false, $submitted_by=false, $scoring_method=false, $calculated_risk=true, $residual_risk=true, $submission_date=true, $review_date=false, $project=false, $mitigation_planned=true, $management_review=true, $days_open=false, $next_review_date=false, $next_step=false, $affected_assets=false, $planning_strategy=false, $planning_date=false, $mitigation_effort=false, $mitigation_cost=false, $mitigation_owner=false, $mitigation_team=false, $mitigation_accepted=false, $mitigation_date=false, $mitigation_controls=false, $risk_assessment=false, $additional_notes=false, $current_solution=false, $security_recommendations=false, $security_requirements=false, $risk_tags=false, $closure_date=false, $custom_values=[])
{
    ...
    echo "<form id=\"get_risks_by\" name=\"get_risks_by\" method=\"post\" action=\"".$_SERVER['REQUEST_URI']."\">\n";
    echo "<div class=\"row-fluid\">\n";
    echo "<div class=\"span12\">\n";
    echo "<a href=\"javascript:;\" onclick=\"javascript: closeSearchBox()\"><img src=\"../images/X-100.png\" width=\"10\" height=\"10\" align=\"right\" /></a>\n";
    echo "</div>\n";
    ...
    global $lang, $escaper;
        ...
        echo "<div class='row-fluid'>";
            echo "<form method='post' >";
                /*  <span>". $ escaper->escapeHtml($ lang['Printdoc']).": &nbsp;&nbsp;&nbsp;</span>"; */
