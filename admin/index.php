<?php
	...
	if (isset($_POST['update_general_settings']))
	{
		...
		//linfinal_score instead of default 10
		//linlast the default in the setting menu
		...
		if ($default_risk_score != $current_default_risk_score)
		{
			...
			if (is_numeric($default_risk_score) && ($default_risk_score >= 0) && ($default_risk_score <= 25))
			{
...
//linde com
	...
	if (isset($_POST['delete_file_type']))
	{
        ...
        if (isset($_POST['test_mail_configuration']))
        {
                ...
                $name = "Geoscience Risk Testing";
                $email = $_POST['email'];
                $subject = "Risk Management Test Email";
                $full_message = "The messages was sent from Risk Management of Geoscience";

                // Send the e-mail
                send_email($name, $email, $subject, $full_message);

                // Display an alert
                set_alert(true, "good", "CGS Currently sending the testing unit");
        }
        ...
        <div class="span9">
          <div class="wrap">
            <ul class="tabs group">
              ...
              <!--li><a href="#/security">< ?php echo $escaper->escapeHtml($lang['Security']); ?></a></li> lindenow-->
                    ...
                    <tr>
                      <td>
                        <table border="0" width="100%">
                          ...
                          <!--  <tr>
                              <td>< linde?php echo $escaper->escapeHtml($lang['SimpleriskBaseUrl']) ?>:</td>
                              <td><input type="text" name="simplerisk_base_url" value="<linde?php echo $escaper->escapeHtml(get_setting("simplerisk_base_url")); ?>" /></td>
                            </tr> -->
                            <tr> 
