  ...
  <div class="row-fluid">
    ...
    <!--  <div class="row-fluid">
      ...
      <div class="row-fluid">
        <div class="span6">
          <div class="hero-unit">
            <p><a href="http://lindelaninevuvha@gmail.com" target="newwindow">Written for  <i><b>Counsil for Geoscience</b></i> partner with NDT intend to simplify daily risk measures and analyse impact to the institute o project</p>
            <p> For more application development contact NDT  &#39;</p>
          </div>
        </div>
        <div class="span6">
          <div class="hero-unit">
            <!--linde START PAYPAL FORM -
