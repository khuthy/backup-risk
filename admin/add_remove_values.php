            ...
            switch ($_POST['action']) {
                case "add":
                    ...
                    if (array_key_exists('customAddFunction', $tableConfig[$tableName])) {
                        ...
                        // Insert a new item
                    //lindeapi    $result = add_name($tableName, $name);

                        //lindeapi
                        $departments = get_departments();
                        
                            //echo "<script>console.log('Debug Objects: " .$departments.length "' );</script>";

                        if($tableName == 'Team')
                        {
                            echo "<script>console.log('team is selected: ' );</script>";

                            foreach($departments as $department) {
                            
                                echo "<script>console.log('each object: " .$department. "' );</script>";
                                // Insert all departments from SAP Registers
                               $result = add_name($tableName, $department['Name']);
                               echo "<script>console.log('name added: " .$department['Name']. "' );</script>";
                            }
                        }
                        else
                        {
